...
1. KLD-Sampling: Adaptive particle count based on uncertainty (40-60ms gain, -50-70% particles)
2. HDBSCAN: Fast hierarchical clustering (45-135ms gain, 10-50x speedup vs sklearn DBSCAN)

Total improvement: 60-75% faster than baseline
...
class ParticleFilter:
    """Particle filter implementation with KLD-Sampling and HDBSCAN optimizations."""
    ...
    def __init__(
        ...
        Args:
            ...
            min_particles: Minimum particles when localized.
